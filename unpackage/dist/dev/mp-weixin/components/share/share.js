...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const preventTouchMove = () => {
      common_vendor.index.__f__("log", "at components/share/share.vue:45", "占位：函数 preventTouchMove 未声明");
    };
    ...
    common_vendor.index.__f__("log", "at components/share/share.vue:53", props.shareModal, "shareModal");
